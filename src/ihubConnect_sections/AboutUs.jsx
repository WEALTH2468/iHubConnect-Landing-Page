...
const AboutUs = () => {
  return (
    <section className="max-w-7xl mx-auto text-center text-gray-800 pb-[70px] ">
      {/* Button */}
      ...
      {/* Paragraph */}
      <p className="text-[20px] leading-9 text-gray-600 mb-6 max-w-[1100px] justify-center mx-auto">
